...
router.post('/encounters/:id/notes', protectHospitalWrite, authorizeHospitalRoles('admin', 'doctor', 'nurse', 'clinical_officer'), hospitalCtrl.addEncounterNote);
router.post('/encounters/:id/tasks', protectHospitalWrite, authorizeHospitalRoles('admin', 'doctor', 'nurse', 'clinical_officer'), hospitalCtrl.addEncounterTask);
router.put('/encounters/:id/tasks/:taskId', protectHospitalWrite, authorizeHospitalRoles('admin', 'doctor', 'nurse', 'clinical_officer'), hospitalCtrl.updateEncounterTask);
router.put('/encounters/:id/checklists/:listType/:itemKey', protectHospitalWrite, authorizeHospitalRoles('admin', 'doctor', 'nurse', 'clinical_officer'), hospitalCtrl.updateEncounterChecklistItem);
